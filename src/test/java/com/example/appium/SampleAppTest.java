...
public class SampleAppTest {
    ...
    private void setUp() {
        ...
        if (platform.equals("ANDROID")) {
            ...
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone 8 (14.4)");
            capabilities.setCapability(MobileCapabilityType.UDID, "2F13F274-AF44-438A-AE07-D130157374FF");
    ...
    public void textFieldTest() {
        ...
        Assert.assertEquals(view.getTextField(), "text", "Text was not set");
    }
